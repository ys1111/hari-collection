...
var writeTextDefault = require('copy-to-clipboard');
var useCopyToClipboard = function (text, options) {
    ...
    var latestText = react_1.useRef(text);
    var _c = react_1.useState(false), copied = _c[0], setCopied = _c[1];
    var copyToClipboard = react_1.useCallback(function () { return __awaiter(_this, void 0, void 0, function () {
        var error_1;
